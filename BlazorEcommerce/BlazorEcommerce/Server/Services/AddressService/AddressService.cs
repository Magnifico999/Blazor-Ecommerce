namespace BlazorEcommerce.Server.Services.AddressService
{
    public class AddressService : IAddressService
    {
        ...
        public async Task<ServiceResponse<Address>> AddOrUpdateAdress(Address address)
        {
            var response = new ServiceResponse<Address>();
            var dbAddress = (await GetAdress()).Data;
            if (dbAddress == null)
            {
        ...
        public async Task<ServiceResponse<Address>> GetAdress()
        {
